...
from Company_project.UI_U2_Forexchat import Description, InputGroupDescription, complete

d=u2.connect('127.0.0.1:21513')
# 获取设备基本信息
# print(d.info)
d.implicitly_wait(10)
from Company_project.UI_U2_Forexchat import editGroupProfiles_set, \

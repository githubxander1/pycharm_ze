...
# 悬停在活动icon上
icon=d.find_element_by_css_selector('#app > div.menu-right.text-center > ul > li:nth-child(1) > div > span > span > div > img')
ActionChains(d).move_to_element(icon).perform()
time.sleep(2)
# # F12--resource--ctrl+\
# d.find_element_by_css_selector('#el-popover-5062 > div.activity-popover > div').click()
d.find_element_by_xpath('//*[@id="el-popover-517"]/div[1]/div').click()
# # 第一种打开方式

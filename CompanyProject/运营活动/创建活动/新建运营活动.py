...
def new(project):
    ...
    if project=='HuiChaCha':
        driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[6]/div/div[2]/div/div[实例25_批量生成PPT版荣誉证书]/span').click()
    ...
    # # # 选择新用户注册
    driver.find_element(By.CSS_SELECTOR,'#app > div > div.right > div.inner > div > div.el-dialog__wrapper > div > div.el-dialog__body > div > div.template-wrap > div:nth-child(实例25_批量生成PPT版荣誉证书) > div > img').click()
    # 点击确定
    sleep(2)
    driver.find_element(By.CSS_SELECTOR,'#app > div > div.right > div.inner > div > div.el-dialog__wrapper > div > div.el-dialog__footer > span > span > button.el-button.el-button--primary.el-button--mini > span').click()
...
# 点击编辑活动
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[4]/div[实例25_批量生成PPT版荣誉证书]/div[3]/table/tbody/tr[实例25_批量生成PPT版荣誉证书]/td[10]/div/button[实例25_批量生成PPT版荣誉证书]/span').click()
#活动地址
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[实例25_批量生成PPT版荣誉证书]/div[2]/div/div[2]/div/label[实例25_批量生成PPT版荣誉证书]/span[实例25_批量生成PPT版荣誉证书]/span').click()
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[实例25_批量生成PPT版荣誉证书]/div[3]/div/div/div/input').send_keys('https://bvwebtestevent.tostar.top')
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[实例25_批量生成PPT版荣誉证书]/div[4]/div/div[实例25_批量生成PPT版荣誉证书]/div/input').send_keys('https://bvh5testevent.tostar.top')
# 奖品类型
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[2]/div[3]/div/div/div/input').click()
driver.find_element(By.XPATH,'/html/body/div[6]/div[实例25_批量生成PPT版荣誉证书]/div[实例25_批量生成PPT版荣誉证书]/ul/li').click()

# 日期
sleep(1)
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[实例25_批量生成PPT版荣誉证书]/div[6]/div/div/input[实例25_批量生成PPT版荣誉证书]').send_keys('2023-10-04 00:00:00')
sleep(1)
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[实例25_批量生成PPT版荣誉证书]/div[6]/div/div/input[2]').send_keys('2023-11-16 23:59:59')
# 提现网络
...
# 邀请人奖金参数
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[2]/div[5]/div/div/div[实例25_批量生成PPT版荣誉证书]/label/span[实例25_批量生成PPT版荣誉证书]/span').click()
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[2]/div[5]/div/div/div[实例25_批量生成PPT版荣誉证书]/label/span[2]/span/div/input').clear()
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[2]/div[5]/div/div/div[实例25_批量生成PPT版荣誉证书]/label/span[2]/span/div/input').send_keys(50)
# 特殊国家
def special():
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[2]/div[6]/div/div/div[3]/table/tbody/tr[实例25_批量生成PPT版荣誉证书]/td[2]/div/div/input').send_keys(40)
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[2]/div[6]/div/div/div[3]/table/tbody/tr[实例25_批量生成PPT版荣誉证书]/td[3]/div/div/input').send_keys(1000)
...
# 被邀请人关联奖金配置
sleep(2)
fixed_button = driver.find_element(By.XPATH, '//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/div[3]/form/div/div/div/div[实例25_批量生成PPT版荣誉证书]/label/span[实例25_批量生成PPT版荣誉证书]')
ActionChains(driver).move_to_element(fixed_button).perform()
fixed_button.click()
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/div[3]/form/div/div/div/div[实例25_批量生成PPT版荣誉证书]/label/span[2]/span/div/input').send_keys(20)

# 客户端展示信息
def language():
    # 简中
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[实例25_批量生成PPT版荣誉证书]/label[实例25_批量生成PPT版荣誉证书]/span').click()#点击简中
    ...
    gaishu=driver.find_element(By.XPATH,'/html/body/div[实例25_批量生成PPT版荣誉证书]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[5]/div/div/div/div[实例25_批量生成PPT版荣誉证书]/div[2]/div[实例25_批量生成PPT版荣誉证书]/iframe')
    ...
    driver.switch_to.frame(driver.find_element(By.XPATH,'/html/body/div[实例25_批量生成PPT版荣誉证书]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[6]/div/div/div/div[实例25_批量生成PPT版荣誉证书]/div[2]/div[实例25_批量生成PPT版荣誉证书]/iframe'))
    driver.find_element(By.TAG_NAME,'body').clear()#清空内容
    driver.find_element(By.ID,'tinymce').send_keys(CN.rules)
    driver.switch_to.default_content()#切换回默认的上下文

    driver.switch_to.frame(driver.find_element(By.XPATH,'/html/body/div[实例25_批量生成PPT版荣誉证书]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[7]/div/div/div/div[实例25_批量生成PPT版荣誉证书]/div[2]/div[实例25_批量生成PPT版荣誉证书]/iframe'))
    driver.find_element(By.TAG_NAME,'body').clear()#清空内容
    driver.find_element(By.ID,'tinymce').send_keys(CN.Withdrawalrules)
    driver.switch_to.default_content()#切换回默认的上下文

    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[8]/div/div[实例25_批量生成PPT版荣誉证书]/textarea').send_keys(CN.rewards_object)

    driver.switch_to.frame(driver.find_element(By.XPATH,'/html/body/div[实例25_批量生成PPT版荣誉证书]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[9]/div/div/div/div[实例25_批量生成PPT版荣誉证书]/div[2]/div[实例25_批量生成PPT版荣誉证书]/iframe'))
    driver.find_element(By.TAG_NAME,'body').clear()#清空内容
    driver.find_element(By.ID,'tinymce').send_keys(CN.attention)
    driver.switch_to.default_content()#切换回默认的上下文'))
    sleep(2)
    # 繁中
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[实例25_批量生成PPT版荣誉证书]/label[2]/span').click()#点击繁中
    ...
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[8]/div/div[实例25_批量生成PPT版荣誉证书]/textarea').send_keys('客态-奖励')
    ...
    # 英语
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[实例25_批量生成PPT版荣誉证书]/label[3]/span').click()#点击英语
    ...
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[8]/div/div[实例25_批量生成PPT版荣誉证书]/textarea').send_keys(EN.rewards_object)
    ...
    # 阿语
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[实例25_批量生成PPT版荣誉证书]/label[4]/span').click()#点击阿语
    ...
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[8]/div/div[实例25_批量生成PPT版荣誉证书]/textarea').send_keys(AR.rewards_object)
    ...
    # # 马来语
    # driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[实例25_批量生成PPT版荣誉证书]/label[4]/span').click()#点击马来语
    ...
    #                              '/html/body/div[实例25_批量生成PPT版荣誉证书]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[5]/div/div/div/div[实例25_批量生成PPT版荣誉证书]/div[2]/div[实例25_批量生成PPT版荣誉证书]/iframe')
    # driver.switch_to.frame(gaishu)  # 切换到iframe
    # driver.find_element(By.TAG_NAME, 'body').clear()  # 清空内容
    # driver.find_element(By.TAG_NAME, 'body').send_keys(AR.Overviewofrules)
    # driver.switch_to.default_content()  # 切换回默认的上下文
    ...
    #                                            '/html/body/div[实例25_批量生成PPT版荣誉证书]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[6]/div/div/div/div[实例25_批量生成PPT版荣誉证书]/div[2]/div[实例25_批量生成PPT版荣誉证书]/iframe'))
    # driver.find_element(By.TAG_NAME, 'body').clear()  # 清空内容
    # driver.find_element(By.ID, 'tinymce').send_keys(AR.rules)
    # driver.switch_to.default_content()  # 切换回默认的上下文
    #
    # driver.switch_to.frame(driver.find_element(By.XPATH,
    #                                            '/html/body/div[实例25_批量生成PPT版荣誉证书]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[7]/div/div/div/div[实例25_批量生成PPT版荣誉证书]/div[2]/div[实例25_批量生成PPT版荣誉证书]/iframe'))
    # driver.find_element(By.TAG_NAME, 'body').clear()  # 清空内容
    # driver.find_element(By.ID, 'tinymce').send_keys(AR.Withdrawalrules)
    # driver.switch_to.default_content()  # 切换回默认的上下文
    #
    # driver.find_element(By.XPATH,
    #                     '//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[8]/div/div[实例25_批量生成PPT版荣誉证书]/textarea').send_keys(
    #     AR.rewards_object)
    #
    # driver.switch_to.frame(driver.find_element(By.XPATH,
    #                                            '/html/body/div[实例25_批量生成PPT版荣誉证书]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[9]/div/div/div/div[实例25_批量生成PPT版荣誉证书]/div[2]/div[实例25_批量生成PPT版荣誉证书]/iframe'))
    # driver.find_element(By.TAG_NAME, 'body').clear()  # 清空内容
    # driver.find_element(By.ID, 'tinymce').send_keys(AR.attention)
    # driver.switch_to.default_content()  # 切换回默认的上下文'))
    # sleep(2)
    ...
    # 泰语
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[实例25_批量生成PPT版荣誉证书]/label[5]/span').click()#点击泰语
    ...
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[8]/div/div[实例25_批量生成PPT版荣誉证书]/textarea').send_keys(TH.rewards_object)
    ...
    # 越南语
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[实例25_批量生成PPT版荣誉证书]/label[6]/span').click()#点击越南语
    ...
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[8]/div/div[实例25_批量生成PPT版荣誉证书]/textarea').send_keys(VN.rewards_object)
    ...
    # 印尼语
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[实例25_批量生成PPT版荣誉证书]/label[7]/span').click()#点击印尼语
    ...
    driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/form[3]/div[8]/div/div[实例25_批量生成PPT版荣誉证书]/textarea').send_keys(ID.rewards_object)

...
You are eligible to be paid if your balance exceeds the withdrawal threshold. Please add your wallet address when submitting withdrawal application, which will be reviewed by our team. You will receive a notification and an email if your withdrawal application has been processed successfully.
...
- Identity theft or fake account and info;

- Get bonus using tech or rule loopholes;

- Multiple accounts or device under the same IP address;

- Create or maintain accounts with the intent of trying to get around BrokersView's rules;

- Any similar activities considered by BrokersView in its sole discretion to be inconsistent with the BrokersView Referral Program;
...
3. Your withdrawal application will be reviewed.

4. You will receive a notification and an email if your withdrawal application has been processed successfully.'''
    rewards_object='''Sign up, Refer, Earn! \n Invite friends to earn unlimited bonus!'''
    attention='''How does the BrokersView Referral Program work?
...
أنت مؤهل للحصول على أموال إذا تجاوز رصيدك حد السحب. يرجى إضافة عنوان محفظتك عند تقديم طلب السحب، والذي سيتم مراجعته من قبل فريقنا. ستتلقى إشعارًا ورسالة بريد إلكتروني إذا تمت معالجة طلب السحب الخاص بك بنجاح.
...
- سرقة الهوية أو الحساب والمعلومات المزيفة؛

- احصل على مكافأة باستخدام ثغرات التكنولوجيا أو القواعد؛

- حسابات أو أجهزة متعددة تحت نفس عنوان IP؛

- إنشاء حسابات أو الاحتفاظ بها بهدف محاولة الالتفاف على قواعد BrokersView؛

- أي أنشطة مماثلة تعتبرها BrokersView وفقًا لتقديرها الخاص غير متوافقة مع برنامج إحالة BrokersView؛

 3. برنامج الإحالة BrokersView ينطبق فقط على المستخدمين المقيمين في مناطق محددة؛ 

4. جميع الحقوق محفوظة لشركة BrokersView. يرجى الاتصال بـservice@brokersview.com إذا كان لديك أي أسئلة.
...
3. ستتم مراجعة طلب السحب الخاص بك.

4. ستتلقى إشعارًا ورسالة بريد إلكتروني إذا تمت معالجة طلب السحب الخاص بك بنجاح."'''
    rewards_object='''قم بالتسجيل، والإحالة، والكسب! \n قم بدعوة الأصدقاء للحصول على مكافأة غير محدودة!'''
    attention='''كيف يعمل برنامج الإحالة BrokersView؟
...
คุณมีสิทธิ์การถอนเงินหากยอดเงินของคุณถึงเกณฑ์การถอน โปรดเพิ่มwallet addressของคุณเมื่อส่งใบสมัครถอนเงิน ซึ่งทีมงานของเราจะตรวจสอบ คุณจะได้รับการแจ้งเตือนและอีเมลหากใบสมัครถอนเงินของคุณได้รับการดำเนินการเรียบร้อยแล้ว
...
- การโจรกรรมข้อมูลประจำตัวหรือบัญชีและข้อมูลปลอม

- รับโบนัสโดยใช้เทคโนโลยีหรือช่องโหว่ของกฎ

- หลายบัญชีหรืออุปกรณ์ภายใต้ที่อยู่ IP เดียวกัน

- สร้างหรือรักษาบัญชีโดยมีจุดประสงค์เพื่อพยายามหลีกเลี่ยงกฎของ BrokersView

- กิจกรรมที่คล้ายคลึงกันใด ๆ ที่ BrokersView พิจารณาตามดุลยพินิจของตนแต่เพียงผู้เดียวว่าไม่สอดคล้องกับโปรแกรมการอ้างอิงของ BrokersView

3. กิจกรรม BrokersView ใช้ได้กับผู้ใช้ที่อยู่ในภูมิภาคที่กำหนดเท่านั้น
...
3. ใบสมัครถอนเงินของคุณจะได้รับการตรวจสอบ

4. คุณจะได้รับการแจ้งเตือนและอีเมลหากใบสมัครถอนเงินของคุณได้รับการดำเนินการเรียบร้อยแล้ว'''
    rewards_object='''ลงทะเบียน เชิญชวน รับโบนัส! \n เชิญเพื่อนเพื่อรับโบนัสไม่จำกัด!'''
    attention='''กฎกิจกรรม
...
Khi tổng số tiền thưởng mà bạn đã kiếm được đã vượt qua mức giới hạn rút tiền tối thiểu, thì bạn sẽ có tư cách gửi đơn xin rút tiền. Vui lòng thêm địa chỉ ví của bạn khi gửi đơn xin rút tiền, và địa chỉ này sẽ được xét duyệt bởi Team BrokersView. Bạn sẽ nhận được thông báo và Email, khi đơn xin rút tiền của bạn được xử lý thành công. 
...
- Trộm cắp danh tính hoặc giả mạo tài khoản và thông tin;

- Nhận tiền thưởng thông qua sử dụng các lỗ hổng kỹ thuật hoặc quy tắc;

- Sử dụng nhiều tài khoản hoặc thiết bị trong cùng một địa chỉ IP;

- Tạo hoặc duy trì tài khoản với mục đích cố gắng lách các quy tắc của BrokersView;

-  Bất kỳ hành động  tương tự nào mà được BrokersView xác nhận là không phù hợp với quy định của Chương trình giới thiệu BrokersView;

3. Chương trình giới thiệu BrokersView chỉ áp dụng cho người dùng ở các khu vực cụ thể;

4. BrokersView bảo lưu mọi quyền. Nếu bạn có bất kỳ vấn đề nào, vui lòng liên hệ chúng tôi qua Email service@brokersview.com
...
3. Đơn xin rút tiền của bạn sẽ được xét duyệt bởi Team FastBull;

4. Bạn sẽ nhận được thông báo và Email, khi đơn xin rút tiền của bạn được xử lý thành công.'''
    rewards_object='''Đăng ký tài khoản, giới thiệu bạn bè để kiếm tiền thưởng! \n Giới thiệu bạn bè để kiếm tiền thưởng không giới hạn!'''
    attention='''Chương trình giới thiệu BrokersView hoạt động như thế nào? 
...
Anda berhak menerima pembayaran jika saldo Anda melebihi ambang batas penarikan. Silakan tambahkan alamat dompet Anda saat mengajukan permohonan penarikan, yang akan ditinjau oleh tim kami. Anda akan menerima notifikasi dan email jika permohonan penarikan Anda telah berhasil diproses.
...
- Dapatkan bonus menggunakan celah teknologi atau aturan;

- Beberapa akun atau perangkat dengan alamat IP yang sama;

- Membuat atau mengelola akun dengan tujuan untuk mencoba menghindari aturan BrokersView;

- Aktivitas serupa apa pun yang dianggap oleh BrokersView berdasarkan kebijakannya sendiri tidak sesuai dengan Program Rujukan BrokersView;

3. Program Rujukan BrokersView hanya berlaku untuk pengguna yang berbasis di wilayah tertentu;
...
3. Permohonan penarikan Anda akan ditinjau.

4. Anda akan menerima notifikasi dan email jika permohonan penarikan Anda telah berhasil diproses.'''
    rewards_object='''Daftar, Rujuk, Dapatkan! \n Undang teman untuk mendapatkan bonus tak terbatas!'''
    attention='''Bagaimana cara kerja Program Referensi BrokersView? 

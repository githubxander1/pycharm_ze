...
#
# # # 手机号登录
# d.find_element(By.XPATH,'//*[@id="app"]/div[实例25_批量生成PPT版荣誉证书]/div[2]/header/div/div[2]/div/div[3]/div/p/a').click()
...
# # 悬停在活动icon上
# icon=d.find_element(By.XPATH,'//*[@id="app"]/div[6]/ul/li[实例25_批量生成PPT版荣誉证书]/div/span/span/div/img')
# ActionChains(d).move_to_element(icon).perform()
# time.sleep(2)
# # # F12--resource--ctrl+\
# # 用完整的xpath定位
# d.find_element(By.XPATH,'/html/body/div[2]/div[实例25_批量生成PPT版荣誉证书]/div').click()

# 进入邀请弹窗，点击登录
# iframe=d.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/iframe')
# d.switch_to.frame(iframe)
# d.find_element(By.XPATH,'//*[@id="invitation"]/div[2]/div[实例25_批量生成PPT版荣誉证书]/div').click()
# time.sleep(3)
# # 手机号登录
# d.find_element(By.XPATH,'//div[contains(@class,"region-select")]//input').send_keys("+852")
# d.find_element_by_css_selector('[placeholder="请输入手机号"]').send_keys('91111111')
...
# 关联奖金配置
sleep(2)
# driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/div[3]/form/div/div/div/div[1]/label/span[1]/input').click()
driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/div[3]/form/div/div/div/div[1]/label/span[1]/span').click()
# driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[3]/div/div[3]/form/div/div/div/div[1]/label/span[2]').click()
# driver.find_element(By.CSS_SELECTOR,'#app > div > div.right > div.inner > div > div:nth-child(3) > div > div:nth-child(5) > form > div > div > div > div:nth-child(1) > label > span.el-radio__input.is-checked > span').click()

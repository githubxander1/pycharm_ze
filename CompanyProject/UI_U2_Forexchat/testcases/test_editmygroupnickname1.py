...
class Test_groupDescription(unittest.TestCase):
    ...
    #     GroupSet().nickname_set(text)
    #     time.sleep(1)
    #     while not GroupSet.disbandgroup.exists():
    #         d.rotation.sleep()
    #         d.screenshot('nickname_set_abnormal.png')
    #     logging.info("异常值")
    #
    ...
    #     while not GroupSet.disbandgroup.exists():
    #         d.rotation.sleep()
    #         d.screenshot('nickname_set_newline.png')
    #     logging.info("换行")

...
# 点击进入滑块界面
driver.find_element_by_xpath('//*[@id="gt-showZh-mobile"]/div/section/div/div[2]/div[1]/div[2]/div[3]/div[3]').click()
time.sleep(1)
driver.find_element_by_xpath('//*[@id="captcha"]/div[2]/div[1]/div[1]').click()
# 点击完成验证
